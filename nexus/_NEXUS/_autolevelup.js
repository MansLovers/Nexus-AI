...
export async function before(m) {
  ...
  if (user.level <= 2) {
    ...
    user.role = "Kroco Amat 1 ⚊¹";
  } else if (user.level <= 6) {
    user.role = "Kroco Amat 2 ⚊²";
  } else if (user.level <= 8) {
    user.role = "Kroco Amat 3 ⚊³";
  } else if (user.level <= 10) {
    user.role = "Kroco Amat 4 ⚊⁴";
  } else if (user.level <= 12) {
    user.role = "Lumayan Kroco 1 ⚌¹";
  } else if (user.level <= 14) {
    user.role = "Lumayan Kroco 2 ⚌²";
  } else if (user.level <= 16) {
    user.role = "Lumayan Kroco 3 ⚌³";
  } else if (user.level <= 18) {
    user.role = "Lumayan Kroco 4 ⚌⁴";
  } else if (user.level <= 20) {
    user.role = "Lumayan Kroco 5 ⚌⁵";
  ...
  if (before !== user.level) {
    ...
    try {
      ...
      image = await new canvafy.LevelUp()
        ...
        .setBackground(
          "image",
          "https://telegra.ph/file/2f2c737d63d0e62014701.jpg"
        )
        .setUsername(nama)
        .setBorder("#000000")
